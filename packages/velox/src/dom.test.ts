...
describe('DOM Renderer', () => {
    it('should render a simple element', () => {
        const div = h('div', { id: 'test', className: 'foo' }, 'Hello');
    ...
    it('should handle click events', () => {
        const handler = vi.fn();
        const btn = h('button', { onClick: handler }, 'Click me');
    ...
    it('should react to signal changes in text content', () => {
        ...
        const div = h('div', null, count); // count passed as function
    ...
    it('should react to signal changes in attributes', () => {
        ...
        const div = h('div', { 'data-active': active }, 'Toggle');
    ...
    it('should render functional components', () => {
        ...
        const div = h('div', null, h(Component, { text: 'World' }));
